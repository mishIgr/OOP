...
Player::Player() : counter_life(5), counter_double_jump(5), invulnerability(0) {}

Player::Player(unsigned counter_life, unsigned counter_double_jump) : invulnerability(0) {
...
unsigned Player::get_invulnerability() const { return this->invulnerability; }
void Player::set_invulnerability(unsigned invulnerability) { this->invulnerability = invulnerability;; }
