...
unsigned Player::get_life() { return this->counter_life; }
void Player::set_life(unsigned counter_life) { this->counter_life = counter_life > 20 ? 20 : counter_life; }
bool Player::is_alive() { return this->counter_life != 0; }

unsigned Player::get_double_jump() { return this->counter_double_jump; }
